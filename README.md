...
The production application is at **[synod-titles](https://github.com/yusufmiahav/synodindicators)** — a Node.js local server with the complete 505-member database, real VMix API integration, Excel session log export, keyboard shortcuts, and multi-operator WebSocket support.
