...
A standalone interactive demo of the [General Synod Title Controller](https://github.com/yusufmiahav/synod-demo) for client presentations.
...
The production application is at **[synodindicators](https://github.com/yusufmiahav/synodindicators)** — a Node.js local server with the complete 505-member database, real VMix API integration, Excel session log export, keyboard shortcuts, and multi-operator WebSocket support.
